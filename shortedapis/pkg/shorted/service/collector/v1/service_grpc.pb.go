...
func (c *collectorServiceClient) GetSource(ctx context.Context, in *GetSourceRequest, opts ...grpc.CallOption) (*GetSourceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/shorted.service.collector.v1.CollectorService/GetSource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CollectorService_GetSource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shorted.service.collector.v1.CollectorService/GetSource",
	}
...
var CollectorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "shorted.service.collector.v1.CollectorService",
	...
	Metadata: "shorted/service/collector/v1/service.proto",
}
